...
namespace RabbitMQ.Client.Unit
{
    public class TestOAuth2CredentialsProvider
    {
        ...
        {
            Assert.AreEqual("aName", _provider.Name);
        }
        ...
        public void ShouldRequestTokenWhenAskToRefresh()
        {
            ...
            _provider.Refresh();
            Assert.AreEqual("the_access_token", _provider.Password);
        }
        ...
        public void ShouldRequestTokenWhenGettingPasswordOrValidUntilForFirstTimeAccess()
        {
            ...
            Assert.AreEqual(firstToken.AccessToken, _provider.Password);
            Assert.AreEqual(firstToken.ExpiresIn, _provider.ValidUntil.Value);
        }
        ...
        public void ShouldRefreshTokenUsingRefreshTokenWhenAvailable()
        {
            ...
            Assert.AreEqual(refreshedToken.AccessToken, _provider.Password);
            Assert.AreEqual(refreshedToken.ExpiresIn, _provider.ValidUntil.Value);
        }
