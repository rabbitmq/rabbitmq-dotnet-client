...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    internal sealed class QueueDeleteOk : Client.Impl.MethodBase, IQueueDeleteOk
    {
        ...
        public QueueDeleteOk(uint @MessageCount) => _messageCount = @MessageCount;

        public override uint ProtocolCommandId => MethodConstants.QueueDeleteOk;
        public override string ProtocolMethodName => "queue.delete-ok";
        public override bool HasContent => false;

        public override void ReadArgumentsFrom(ref Client.Impl.MethodArgumentReader reader) => _messageCount = reader.ReadLong();

        public override void WriteArgumentsTo(ref Client.Impl.MethodArgumentWriter writer) => writer.WriteLong(_messageCount);
