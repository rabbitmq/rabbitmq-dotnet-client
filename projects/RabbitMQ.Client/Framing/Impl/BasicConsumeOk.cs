...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    internal sealed class BasicConsumeOk : Client.Impl.MethodBase, IBasicConsumeOk
    {
        ...
        public BasicConsumeOk(string @ConsumerTag) => _consumerTag = @ConsumerTag;

        public override uint ProtocolCommandId => MethodConstants.BasicConsumeOk;
        public override string ProtocolMethodName => "basic.consume-ok";
        public override bool HasContent => false;

        public override void ReadArgumentsFrom(ref Client.Impl.MethodArgumentReader reader) => _consumerTag = reader.ReadShortstr();

        public override void WriteArgumentsTo(ref Client.Impl.MethodArgumentWriter writer) => writer.WriteShortstr(_consumerTag);
