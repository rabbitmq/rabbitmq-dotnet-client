...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    internal sealed class ExchangeUnbind : Client.Impl.MethodBase
    {
        ...
        {
            int bufferSize = 6; // bytes for _reserved1, length of _destination, length of _source, length of _routingKey, bit fields
