...
namespace MassPublish
{
    static class Program
    {
        ...
        static async Task Main()
        {
            ...
            consumeConnection.ConnectionShutdownAsync += Connection_ConnectionShutdownAsync;
            ...
            for (int i = 0; i < ConnectionCount; i++)
            {
                ...
                publishConnection.ConnectionShutdownAsync += Connection_ConnectionShutdownAsync;
        ...
        private static Task Connection_ConnectionShutdownAsync(object sender, ShutdownEventArgs e)
        {
