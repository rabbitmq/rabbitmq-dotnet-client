...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    internal sealed class BasicRecoverAsync : Client.Impl.MethodBase, IBasicRecoverAsync
    {
        ...
        public BasicRecoverAsync(bool @Requeue) => _requeue = @Requeue;

        public override uint ProtocolCommandId => MethodConstants.BasicRecoverAsync;
        public override string ProtocolMethodName => "basic.recover-async";
        public override bool HasContent => false;

        public override void ReadArgumentsFrom(ref Client.Impl.MethodArgumentReader reader) => _requeue = reader.ReadBit();

        public override void WriteArgumentsTo(ref Client.Impl.MethodArgumentWriter writer) => writer.WriteBit(_requeue);
