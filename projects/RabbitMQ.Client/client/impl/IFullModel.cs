...
namespace RabbitMQ.Client.Apigen.Attributes
{
    ...
    internal abstract class AmqpApigenAttribute : Attribute
    {
        ...
        public AmqpApigenAttribute(string namespaceName) => m_namespaceName = namespaceName;
    }
    ...
    internal class AmqpFieldMappingAttribute : AmqpApigenAttribute
    {
        ...
        public AmqpFieldMappingAttribute(string namespaceName,
            string fieldName)
            : base(namespaceName) => m_fieldName = fieldName;
    }
    ...
    internal class AmqpNowaitArgumentAttribute : AmqpApigenAttribute
    {
        ...
        public AmqpNowaitArgumentAttribute(string namespaceName,
            ...
            : base(namespaceName) => m_replacementExpression = replacementExpression;
    }
    ...
    internal class AmqpContentHeaderFactoryAttribute : Attribute
    {
        ...
        public AmqpContentHeaderFactoryAttribute(string contentClass) => m_contentClass = contentClass;
    }
