...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    internal sealed class ConnectionBlocked : Client.Impl.MethodBase, IConnectionBlocked
    {
        ...
        public ConnectionBlocked(string @Reason) => _reason = @Reason;

        public override uint ProtocolCommandId => MethodConstants.ConnectionBlocked;
        public override string ProtocolMethodName => "connection.blocked";
        public override bool HasContent => false;

        public override void ReadArgumentsFrom(ref Client.Impl.MethodArgumentReader reader) => _reason = reader.ReadShortstr();

        public override void WriteArgumentsTo(ref Client.Impl.MethodArgumentWriter writer) => writer.WriteShortstr(_reason);
