...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    internal sealed class BasicQos : Client.Impl.MethodBase
    {
        ...
        uint PrefetchSize => _prefetchSize;
        ushort PrefetchCount => _prefetchCount;
        bool Global => _global;
        ...
        {
            int bufferSize = 7; // bytes for _prefetchSize, _prefetchCount, bit fields
            return bufferSize;
        }
        ...
        {
            sb.Append('(');
            sb.Append(_prefetchSize).Append(',');
            sb.Append(_prefetchCount).Append(',');
            sb.Append(_global);
            sb.Append(')');
        }
    }
