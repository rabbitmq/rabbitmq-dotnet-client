...
namespace RabbitMQ.Client.Impl
{
    ...
    public abstract class AsyncMethodBase : IMethod
    {
        public abstract bool HasContent { get; }
        ...
        public abstract void AppendArgumentDebugStringTo(StringBuilder stringBuilder);
        public abstract Task ReadArgumentsFrom(MethodArgumentReader reader);
        public abstract Task WriteArgumentsTo(AsyncMethodArgumentWriter writer);
    }
}
