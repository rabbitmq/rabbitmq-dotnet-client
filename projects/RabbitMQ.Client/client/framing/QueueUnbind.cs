...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    internal sealed class QueueUnbind : Client.Impl.MethodBase
    {
        ...
        {
            int bufferSize = 5; // bytes for _reserved1, length of _queue, length of _exchange, length of _routingKey
