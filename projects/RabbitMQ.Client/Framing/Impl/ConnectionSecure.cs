...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    internal sealed class ConnectionSecure : Client.Impl.MethodBase, IConnectionSecure
    {
        ...
        public ConnectionSecure(byte[] @Challenge) => _challenge = @Challenge;

        public override uint ProtocolCommandId => MethodConstants.ConnectionSecure;
        public override string ProtocolMethodName => "connection.secure";
        public override bool HasContent => false;

        public override void ReadArgumentsFrom(ref Client.Impl.MethodArgumentReader reader) => _challenge = reader.ReadLongstr();

        public override void WriteArgumentsTo(ref Client.Impl.MethodArgumentWriter writer) => writer.WriteLongstr(_challenge);
