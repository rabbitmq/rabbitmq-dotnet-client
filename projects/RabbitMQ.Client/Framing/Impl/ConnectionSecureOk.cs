...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    internal sealed class ConnectionSecureOk : Client.Impl.MethodBase, IConnectionSecureOk
    {
        ...
        public ConnectionSecureOk(byte[] @Response) => _response = @Response;

        public override uint ProtocolCommandId => MethodConstants.ConnectionSecureOk;
        public override string ProtocolMethodName => "connection.secure-ok";
        public override bool HasContent => false;

        public override void ReadArgumentsFrom(ref Client.Impl.MethodArgumentReader reader) => _response = reader.ReadLongstr();

        public override void WriteArgumentsTo(ref Client.Impl.MethodArgumentWriter writer) => writer.WriteLongstr(_response);
