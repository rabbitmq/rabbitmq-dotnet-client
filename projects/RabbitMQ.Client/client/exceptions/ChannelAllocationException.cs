...
namespace RabbitMQ.Client.Exceptions
{
    ...
    public class ChannelAllocationException : ProtocolViolationException
    {
        ...
        public ChannelAllocationException()
            : base("The connection cannot support any more channels. Consider creating a new connection") => Channel = -1;
        ...
        public ChannelAllocationException(int channel)
            : base($"The Requested Channel ({channel}) is already in use.") => Channel = channel;
