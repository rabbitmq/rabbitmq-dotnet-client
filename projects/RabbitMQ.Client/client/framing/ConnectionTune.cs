...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    internal sealed class ConnectionTune : Client.Impl.MethodBase
    {
        ...
        ushort ChannelMax => _channelMax;
        uint FrameMax => _frameMax;
        ushort Heartbeat => _heartbeat;
        ...
        {
            int bufferSize = 8; // bytes for _channelMax, _frameMax, _heartbeat
            return bufferSize;
        }
        ...
        {
            sb.Append('(');
            sb.Append(_channelMax).Append(',');
            sb.Append(_frameMax).Append(',');
