...
namespace OAuth2
{
    public static class Program
    {
        ...
        public static IModel declarePublisher(IConnection connection)
        {
        ...
        public static IModel declareConsumer(IConnection connection)
        {
        ...
        public static void Consume(IModel subscriber)
        {
