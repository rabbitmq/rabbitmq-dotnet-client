...
# use TESTCASE to specify which test case to run, e.g.
# make test-one TESTCASE=RabbitMQ.Client.Unit.TestIDisposable
test-one: compile
	nunit-console projects/client/Unit/build/bin/unit-tests.dll -run:$(TESTCASE)
