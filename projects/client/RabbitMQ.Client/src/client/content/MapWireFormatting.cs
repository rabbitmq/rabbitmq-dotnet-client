...
//            return table;
//        }
//        public static async Task<IDictionary<string, object>> ReadMapAsync(NetworkBinaryReader reader)
//        {
//            int entryCount = reader.ReadInt32();
//            if (entryCount < 0)
//            {
...
//            {
//                string key = StreamWireFormatting.ReadUntypedString(reader);
//                object value = await StreamWireFormatting.ReadObjectAsync(reader);
//                table[key] = value;
//            }
