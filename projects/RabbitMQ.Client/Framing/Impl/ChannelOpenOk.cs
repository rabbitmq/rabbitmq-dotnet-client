...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    internal sealed class ChannelOpenOk : Client.Impl.MethodBase, IChannelOpenOk
    {
        ...
        public ChannelOpenOk(byte[] @Reserved1) => _reserved1 = @Reserved1;

        public override uint ProtocolCommandId => MethodConstants.ChannelOpenOk;
        public override string ProtocolMethodName => "channel.open-ok";
        public override bool HasContent => false;

        public override void ReadArgumentsFrom(ref Client.Impl.MethodArgumentReader reader) => _reserved1 = reader.ReadLongstr();

        public override void WriteArgumentsTo(ref Client.Impl.MethodArgumentWriter writer) => writer.WriteLongstr(_reserved1);
