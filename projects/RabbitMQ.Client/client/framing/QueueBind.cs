...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    internal sealed class QueueBind : Client.Impl.MethodBase
    {
        ...
        {
            int bufferSize = 6; // bytes for _reserved1, length of _queue, length of _exchange, length of _routingKey, bit fields
