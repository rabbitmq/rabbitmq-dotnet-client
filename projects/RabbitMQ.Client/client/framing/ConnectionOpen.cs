...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    internal sealed class ConnectionOpen : Client.Impl.MethodBase
    {
        ...
        string VirtualHost => _virtualHost;
        string Reserved1 => _reserved1;
        bool Reserved2 => _reserved2;
        ...
        {
            int bufferSize = 3; // bytes for length of _virtualHost, length of _reserved1, bit fields
