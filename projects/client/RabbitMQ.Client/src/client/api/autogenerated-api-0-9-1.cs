...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    public partial class Model : RabbitMQ.Client.Impl.ModelBase
    {
        ...
        public Model(RabbitMQ.Client.Impl.ISession session, ConsumerWorkService workService) : base(session, workService) { }
        ...
        //public override async Task _Private_ConnectionOpenAsync(string @virtualHost, string @capabilities, bool @insist)
        //{
        //    ConnectionOpen __req = new ConnectionOpen();
        //    __req.m_virtualHost = @virtualHost;
        //    __req.m_reserved1 = @capabilities;
