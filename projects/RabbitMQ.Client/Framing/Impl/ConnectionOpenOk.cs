...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    internal sealed class ConnectionOpenOk : Client.Impl.MethodBase, IConnectionOpenOk
    {
        ...
        public ConnectionOpenOk(string @Reserved1) => _reserved1 = @Reserved1;

        public override uint ProtocolCommandId => MethodConstants.ConnectionOpenOk;
        public override string ProtocolMethodName => "connection.open-ok";
        public override bool HasContent => false;

        public override void ReadArgumentsFrom(ref Client.Impl.MethodArgumentReader reader) => _reserved1 = reader.ReadShortstr();

        public override void WriteArgumentsTo(ref Client.Impl.MethodArgumentWriter writer) => writer.WriteShortstr(_reserved1);
