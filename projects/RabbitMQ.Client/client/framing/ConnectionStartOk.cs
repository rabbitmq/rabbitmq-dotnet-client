...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    internal sealed class ConnectionStartOk : Client.Impl.MethodBase
    {
        ...
        IDictionary<string, object> ClientProperties => _clientProperties;
        string Mechanism => _mechanism;
        byte[] Response => _response;
        ...
        {
            int bufferSize = 6; // bytes for length of _mechanism, length of _response, length of _locale
        ...
        {
            sb.Append('(');
            sb.Append(_clientProperties).Append(',');
            sb.Append(_mechanism).Append(',');
            sb.Append(_response).Append(',');
            sb.Append(_locale);
            sb.Append(')');
        }
    }
